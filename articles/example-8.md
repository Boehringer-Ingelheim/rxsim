# Example 8: Seamless Ph2a/2b \| Two-arm -\> Multi-arm \| Single continuous endpoint \| Bayesian Go/No-Go + Bayesian MCP-Mod
...
cond_interim <- Condition$new(
  where = rlang::quos(.data$time %in% interim_time),
...
cond_final <- Condition$new(
  where = rlang::quos(.data$time %in% final_time),
