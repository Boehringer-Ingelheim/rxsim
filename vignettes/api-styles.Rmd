...
- Use deterministic schedules from `deterministic_schedule()` or a hand-built plan.
...
- Build multi-stage designs where the schedule is easier to express directly,
  such as the seamless pattern in [Example 5](example-5.html).
...
- Add interims and multiple analyses: [Conditions and Triggers](conditions.html)
- Learn more about trigger objects and analyses:
  [Conditions and Triggers](conditions.html)
